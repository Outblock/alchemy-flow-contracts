...
pub fun main(ownerAddress: Address, ids: {String:[UInt64]}): [NFTData?] {
    ...
    for key in ids.keys {
        for id in ids[key]! {
            ...
            switch key {
                case "CNN_NFT": d = getCnnNFT(owner: owner, id: id)
                ...
                case "Eternal": d = getEternalShard(owner: owner, id: id)
                ...
                case "Eternal": d = getEternalMoment(owner: owner, id: id)
                case "ThingFund": d = getCaaPass(owner: owner, id: id)
                case "TFCItems": d = getTFCItems(owner: owner, id: id)
                case "GooberXContract": d = getGooberz(owner: owner, id: id)
                case "MintStoreItem": d = getMintStoreItem(owner: owner, id: id)
                case "BnGNFT": d = getBiscuitsNGroovy(owner: owner, id: id)
                ...
                case "BarterYardPackNFT": d = getBarterYardPack(owner: owner, id: id)
                ...
                case "MaxarNFT": d = getMaxarNFT(owner: owner, id: id)
                ...
                case "DooverseItems": d = getDooverseNFT(owner: owner, id: id)
